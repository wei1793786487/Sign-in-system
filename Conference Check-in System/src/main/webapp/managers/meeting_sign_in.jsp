                        ...
                        <div class="table-box">
                            ...
                            <div class="pull-left">
                                <div class="form-group form-inline">
                                    <div class="btn-group">
                                        <button type="button" id="new" class="btn btn-default" title="新建"><i
                            ...
                            <div class="box-tools pull-right">
                                <div class="has-feedback">
                                    ...
                                    <span id="suosuo" class="glyphicon glyphicon-search form-control-feedback"></span>
                                </div>
                            </div>
                            <!--工具栏/-->
...
<%--                                            <button type="button" class="btn bg-olive btn-xs">查看签到人数</button>--%>
...
<script>
        ...
        $.get("/Meeting/meetinglist", {currentPage: currenpage}, function (pb) {
            ...
            for (var i = 0; i < pb.list.length; i++) {
                ...
                var li = '<tr>\n' +
                    ...
                    '\n' +
                    '                                        <td class="text-center">\n' +
                    '                                            <a href="manage_ys.jsp?id=' + route.id + '" class="btn bg-olive btn-xs">查看签到情况</a>\n' +
                    '                                          <a  href="../Signin/face.jsp?mid='+route.id+'" class="btn bg-olive btn-xs">进入签到页面</a>' +
                    '\n' +
                    '                                        </td>\n' +
                    '                                    </tr>'
    ...
    $(document).ready(function () {
        ...
        load(1);
        // 激活导航位置
        setSidebarActive("meeting_sign_in");
